...
# need to make a subclass of trials to be able to restart if interrupted
...
assert os.path.exists(nuc_profile_inVitro),'Error: In Vitro nucleosome data does not exist!'
assert os.path.exists(nuc_profile_inVivo),'Error: In Vivo nucleosome data does not exist!'

run_dir = os.path.join(out_dir, '01_InVitro_hyperopt')
...
files = filesystem.FileSystem(genome_dir ,run_dir,source_profile= nuc_profile_inVitro,overwrite=False,test_fraction = 0.1, val_fraction=0.2,resume = True)
...
# mkdir ../../Test/Hyperopt/Nucleosomes/01_InVitro_hyperopt
#python -u hyperopt_main.py 2> ../../../Test/Hyperopt/Nucleosomes/01_InVitro_hyperopt/out.log &> ../../../Test/Hyperopt/Nucleosomes/01_InVitro_hyperopt/out.log
